...
const SearchButton = () => {
  ...
  return (
    <Disclosure as="nav" className="bg-gray-800 left-0 right-0 top-0 w-full ">
      {({ open }) => (
        <>
          <Disclosure.Button type="button" className="absolute p-2 inset-y-3 right-2 inline-flex  items-center focus:outline-none text-gray-400 rounded-3xl cursor-pointer transitionHover hover:text-white  hover:bg-gray-700  focus:ring-0 focus:ring-inset focus:ring-white">
          ...
          >
            {open && (
              <div className="flex justify-center sm:hidden">
                <div className="bg-gray-800 relative flex items-center justify-evenly h-12 pr-2 pl-2 bottom-2  w-full sm:hidden">
